...
/**
 * Find all SKILL.md one level below ~/.claude/skills. Returns absolute paths.
 * Excludes the lazy-skill-loader self directory.
 */
 ...
 */
function scanPluginSkills(pluginsDir) {
  const out = [];
...
function bootstrap(opts) {
  ...
  if (includePlugins) {
    for (const p of scanPluginSkills(pluginsDir)) {
